...
namespace EasyLease.WebAPI {
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(UserRegistrationDTO.UserName), Description = $"User Name '{userName}' is already taken." }; }
        public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(UserRegistrationDTO.Email), Description = $"Email '{email}' is already taken." }; }
